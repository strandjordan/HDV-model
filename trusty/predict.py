from trusty.utils.predictor import *
import openpifpaf
...
def init_predictor():
    ...
    parser.add_argument('--checkpoint_', default='shufflenetv2k16-apollo-24', type=str, help='OpenPifPaf checkpoint (ApolloCar3D, 24 keypoints)')
